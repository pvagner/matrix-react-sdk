...
export default class MessageComposer extends React.Component {
    ...
    render() {
        ...
        if (this.props.callState && this.props.callState !== 'ended') {
            hangupButton =
                <button key="controls_hangup" className="mx_MessageComposer_hangup" onClick={this.onHangupClick}>
                    <img src="img/hangup.svg" alt="Hangup" title="Hangup" width="25" height="26"/>
                </button>;
        }
        else {
            callButton =
                <button key="controls_call" className="mx_MessageComposer_voicecall" onClick={this.onVoiceCallClick} title="Voice call">
                    <TintableSvg src="img/icon-call.svg" width="35" height="35"/>
                </button>;
            videoCallButton =
                <button key="controls_videocall" className="mx_MessageComposer_videocall" onClick={this.onCallClick} title="Video call">
        ...
        if (canSendMessages) {
            ...
            var uploadButton = (
                <button key="controls_upload" className="mx_MessageComposer_upload"
